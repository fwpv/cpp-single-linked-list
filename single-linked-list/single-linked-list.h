...
class SingleLinkedList {
    ...
    public:
        ...
        [[nodiscard]] bool operator==(const BasicIterator<const Type>& rhs) const noexcept {
            return (node_ == nullptr && rhs.node_ == nullptr) ||
                ( node_ != nullptr && rhs.node_ != nullptr && node_->next_node == rhs.node_->next_node);
        }
        ...
        [[nodiscard]] bool operator==(const BasicIterator<Type>& rhs) const noexcept {
            return *this == static_cast<BasicIterator<const Type>>(rhs);
        }
...
public:
    ...
    SingleLinkedList(InitIterator begin, InitIterator end)
        : size_(0) {
        auto it = begin;
        Node* target_node = &head_;
        while (it != end) {
            target_node->next_node = new Node(*it, nullptr);
